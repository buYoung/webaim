...
func Sethotkey(index, key, keystr string) error {
	...
	if strings.Contains(key, "3/") {
		...
		case "0":
			...
			onid, err = onkey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Onaim()
			})
			getproc.Settings.Hotkeys.On = fmt.Sprintf("%s|%s", key, keystr)
		case "1":
			...
			offid, err = offkey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Offaim()
			})
			getproc.Settings.Hotkeys.Off = fmt.Sprintf("%s|%s", key, keystr)
		case "2":
			...
			redid, err = redkey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.RedColors()
			})
			getproc.Settings.Hotkeys.Red = fmt.Sprintf("%s|%s", key, keystr)
		case "3":
			...
			blueid, err = bluekey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.BlueColors()
			})
			getproc.Settings.Hotkeys.Blue = fmt.Sprintf("%s|%s", key, keystr)
		case "4":
			...
			solosid, err = solokey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.MultipleColors()
			})
			getproc.Settings.Hotkeys.Solo = fmt.Sprintf("%s|%s", key, keystr)
		case "5":
			...
			exitid, err = exitkey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Exitprogram()
			})
			getproc.Settings.Hotkeys.Exit = fmt.Sprintf("%s|%s", key, keystr)
		case "6":
			...
			auonid, err = auonkey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Autoon()
			})
			getproc.Settings.Hotkeys.Autoon = fmt.Sprintf("%s|%s", key, keystr)
		case "7":
			...
			auoffid, err = auoffkey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Autooff()
			})
			getproc.Settings.Hotkeys.Autooff = fmt.Sprintf("%s|%s", key, keystr)
		...
		case "10":
			...
			aufireid, err = aufirekey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Autofire()
			})
			getproc.Settings.Hotkeys.Autofire = fmt.Sprintf("%s|%s", key, keystr)
		case "11":
			...
			bodyid, err = bodykey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Bodyonly()
			})
		...
		case "12":
			...
			headid, err = headkey.Register(hotkey.Modifier(hotkey_none), uint32(numkey), func() {
				getproc.Headonly()
			})
